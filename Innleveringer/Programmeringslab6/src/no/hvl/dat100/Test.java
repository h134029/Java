...
public class Test {
    public static void main(String[] args) {
        ...
        Person P1 = new Student(134029,"DAT-B", "Fortun", "Olav",1010011700);
        Person P2 = new Student(135039, "INF-B", "Midttun", "Espen",1010011800);
        Person P3 = new Laerer(35000,370540,"Mjaanes", "Jan",1010011900);
        ...
        Person P10 = new Student(123987, "INF-A", "Hole", "Maria",1010011900);
